    <div class="span10">
      <?php
        if(isset($id)) echo form_open_multipart('casting/save_item', array('class' => 'form-horizontal'), array('id' => $id));
        else echo form_open_multipart('casting/save_item', array('class' => 'form-horizontal'));
      ?>
        <fieldset>
          ...
          <div class="form-actions">
            ...
            <?php 
              echo anchor("casting/item_list", "Cancel", array('class' => 'btn')); 
            ?>
          </div>
        </fieldset>
      </form>
